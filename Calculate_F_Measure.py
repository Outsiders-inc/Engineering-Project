...
# from source_code.Check_Tags_Ratio import check_tags_ratio_for_resut_file
from Runner.source_code.Check_Tags_Ratio import check_tags_ratio_for_result_file
...
def run_analysis(file_to_analyze):
    ...
    if "/" in file_to_analyze:
        file_name_short = file_to_analyze.split("/")[1]
    else:
        file_name_short = file_to_analyze
...
if __name__ == '__main__':
    run_analysis("manual_output_ome_wiki_e")
    # for each input file:
    # files_to_test = []
    # # For a test
