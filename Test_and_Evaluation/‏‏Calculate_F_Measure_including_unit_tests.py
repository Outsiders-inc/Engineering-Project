...
# TODO : Unused
# Calculates the recall of a sentence, returns integer
def calculate_recall_sentence(gold_names, pred_names):     #TODO - IMPLEMENT !!!!!!!!!!!!!!!!!!!!
    correct = 0
    ...
    if len(gold_names) == 0:
        return 0
    return correct / len(gold_names)


# TODO : Unused
# Calculates the precision of a sentence, returns integer
def calculate_precision_sentece(gold_names, pred_names):  #TODO - IMPLEMENT !!!!!!!!!!!!!!!!!!!!
    correct = 0
    ...
    if len(pred_names) == 0:
        return 0
    return correct / len(pred_names)


# TODO : Unused
# Calculates the F-Measure of a sentence, returns integer
def calculate_F_measure_sentence(gold_sent, pred_sent):
    # call calculate
    gold_names_list = get_name_list_from(gold_sent, 'ALL')
    pred_names_list = get_name_list_from(pred_sent, 'ALL')
    recall_res = calculate_recall_sentence(gold_names_list, pred_names_list)
    precision_res = calculate_precision_sentece(gold_names_list, pred_names_list)
...
if __name__ == '__main__':
    ...
    print("EXPECTED: " + str([[[0], 'PERS'],[[1,2], 'PERS'], [[4], 'DATE'], [[5,6], 'PERS'], [[7], 'PERS'], [[9,10,11], 'LOC']]))
    print()
    ...
    print("Testing 'get_name_list_from' for 'PERS':")
    print("----------------------------------------")
    # Expecting for GOLD: [[[0], 'PERS'],[[1,2], 'PERS'], [[5,6], 'PERS'], [[7], 'PERS']]
    gold_name_list_pers = get_name_list_from(tag_list_gold, 'PERS')
    print("name_list for gold: ")
    print("FOUND: " + str(gold_name_list_pers))
    print("EXPECTED: " + str([[[0], 'PERS'],[[1,2], 'PERS'], [[5,6], 'PERS'], [[7], 'PERS']]))
    print()
    pred_name_list_pers = get_name_list_from(tag_list_pred, 'PERS')
    print("name_list for pred: ")
    print("FOUND: " + str(pred_name_list_pers))
    print("EXPECTED: " + str([[[0], 'PERS'], [[5, 6, 7], 'PERS']]))
    print()
    print("Testing 'get_name_list_from' for 'DATE':")
    print("----------------------------------------")
    # Expecting for GOLD: [[[0], 'PERS'],[[1,2], 'PERS'], [[5,6], 'PERS'], [[7], 'PERS']]
    gold_name_list_date = get_name_list_from(tag_list_gold, 'DATE')
    print("name_list for gold: ")
    print("FOUND: " + str(gold_name_list_date))
    print("EXPECTED: " + str([[[4], 'DATE']]))
    print()
    pred_name_list_date = get_name_list_from(tag_list_pred, 'DATE')
    print("name_list for pred: ")
    print("FOUND: " + str(pred_name_list_date))
    print("EXPECTED: " + str([[[4], 'DATE'],[[8], 'DATE']]))

    print()

    print("Testing 'calculate_recall' for 'ALL':")
    print("-------------------------------------")
    recall_all = calculate_recall_sentence(gold_name_list_all, pred_name_list_all)
    print("FOUND: " + str(recall_all))
    print("EXPECTED: 2/6 = " + str(2/6))
    print()
    print("Testing 'calculate_precision' for 'ALL':")
    print("----------------------------------------")
    prec_all = calculate_precision_sentece(gold_name_list_all, pred_name_list_all)
    ...
    print("--------------------------------------")
    recall_pers = calculate_recall_sentence(gold_name_list_pers, pred_name_list_pers)
    print("FOUND: " + str(recall_pers))
    print("EXPECTED: 1/4 = " + str(1 / 4))
    print()
    print("Testing 'calculate_precision' for 'PERS':")
    print("-----------------------------------------")
    prec_pers = calculate_precision_sentece(gold_name_list_pers, pred_name_list_pers)
    ...
    print("--------------------------------------")
    recall_date = calculate_recall_sentence(gold_name_list_date, pred_name_list_date)
    print("FOUND: " + str(recall_date))
    print("EXPECTED: 1 = " + str(1))
    print()
    print("Testing 'calculate_precision' for 'DATE':")
    print("-----------------------------------------")
    prec_date = calculate_precision_sentece(gold_name_list_date, pred_name_list_date)
    ...
    print("------------------------------")
    f_measure_all = calculate_F_measure_sentence(tag_list_gold, tag_list_pred)
    ...
    print("EXPECTED: 'PERS': 1/3 = " + str(1 / 3) + ", 'ORG': 0 = 0" + ", 'LOC': 0 = 0" + ", 'DATE': 2/3 = " + str(2/ 3)
